...
---
---
In ham radio there are three different lisence classes:<sup>*</sup> **Technician**, **General**, and **Extra**. Each license class builds onto the one before it, granting higher privileges with each class. *Technician → General → Extra*. <sup><small>[1]</small>

### Technician
The Technician license is the least priviliged of the three and is required in order to get both of the two higher classes. It grants:
